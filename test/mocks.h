...
class MockStreamCollector : public Plugin::StreamCollectorInterface
{
  public:
    ...
    // MOCK_METHOD1(SetMaxCollectDuration, void(std::chrono::seconds maxCollectDuration));
    // MOCK_METHOD0(GetMaxCollectDuration, std::chrono::seconds());
    // MOCK_METHOD1(SetMaxMetricsBuffer, void(int64_t maxMetricsBuffer));
    // MOCK_METHOD0(GetMaxMetricsBuffer, int64_t());
